...
#param TO{1..744};
#param Oc{1..738, 1..5};
param tando{1..444, 1..3};
param HeatingEfficiency;
param CoolingEfficiency;
...
var SAV {1..duration} >= 0  default 0.05;							# Supply Air Volume
var SPOT_Status {1..duration, 1..total_rooms} >= 0 default 1;		# SPOT State
