 ...
 */
void Weather::ParseWeatherData(DF_FLOAT &theData, std::string filename, time_t &start_t, time_t &end_t,
...
Eigen::MatrixXf Weather::GetWeatherMatrix(DF_OUTPUT df[], long int n, int total_rooms) {
	Eigen::MatrixXf ext_temperature = Eigen::MatrixXf::Ones(n, total_rooms);
